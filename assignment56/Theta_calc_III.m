function [new_theta,sum_J,dif]=Theta_calc_III(tau,theta,X,Y)
    h_theta=X*theta;
    ...
    for i=1:length(X)
       ...
       derivJ3=(p_x(i,1)-Y(i,1))*X(i,4);
       derivJ4=(p_x(i,1)-Y(i,1))*X(i,5);
       derivJ5=(p_x(i,1)-Y(i,1))*X(i,6);
       sum_derivJ0=sum_derivJ0+derivJ0;
       sum_derivJ1=sum_derivJ1+derivJ1;
       sum_derivJ2=sum_derivJ2+derivJ2;
       sum_derivJ3=sum_derivJ3+derivJ3;
       sum_derivJ4=sum_derivJ4+derivJ4;
       sum_derivJ5=sum_derivJ5+derivJ5;
    end
    gradient(1,1)=sum_derivJ0;
    gradient(2,1)=sum_derivJ1;
    gradient(3,1)=sum_derivJ2;
    gradient(4,1)=sum_derivJ3;
    gradient(5,1)=sum_derivJ4;
    gradient(6,1)=sum_derivJ5;
